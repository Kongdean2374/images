...
enum WorkoutTarget: Equatable, Hashable {
    ...
    func progress(distance: Double, steps: Int, duration: TimeInterval, calories: Double) -> Double {
        switch self {
        case .none: return 0
    ...
    func remainingText(distance: Double, steps: Int, duration: TimeInterval, calories: Double, unit: DistanceUnit) -> String {
        switch self {
        case .none: return ""
