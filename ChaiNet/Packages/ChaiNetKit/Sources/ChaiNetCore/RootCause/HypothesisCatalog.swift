...
public enum HypothesisCatalog {
    ...
    public static let all: [HypothesisModel] = [
        ...
        HypothesisModel(
            ...
            weights: [.loadCorrelatedLatencyInflation: 0.5, .burstRecoverySlow: 0.4, .postLoadRecoveryIncomplete: 0.4, .fullDuplexInterference: 0.3, .loadedLatencyInflationObserved: 2.0, .loadedLatencyRiseLimitedComparison: 1.2, .downloadBufferbloat: 0.3, .uploadBufferbloat: 0.3, .idleLatencyLow: 0.3,
        ...
        HypothesisModel(
            ...
            prior: HypothesisModel.defaultPrior,
            weights: [.fullDuplexInterference: 0.4, .loadCorrelatedLoss: 0.3, .uploadVeryLow: 1.5, .uploadLow: 0.6, .downloadHigh: 0.7, .uploadUnstable: 1.0, .uploadBufferbloat: 1.0,
        ...
        HypothesisModel(
            ...
            prior: HypothesisModel.defaultPrior,
            weights: [.fullDuplexInterference: 0.4, .loadCorrelatedLoss: 0.3, .downloadHigh: 0.7, .uploadVeryLow: 1.0, .uploadLow: 0.4, .uploadUnstable: 1.0, .uploadBufferbloat: 1.0,
        ...
        HypothesisModel(
            ...
            prior: HypothesisModel.defaultPrior,
            weights: [.sustainedThroughputDegradation: 0.4, .loadCorrelatedLoss: 0.3, .allServersAnomalous: 1.5, .multipleServersAnomalous: 1.0, .deviatesFromBaseline: 0.7, .lossHigh: 0.5,
        ...
        HypothesisModel(
            ...
            prior: HypothesisModel.defaultPrior,
            weights: [.multiDestinationHigherAggregate: 0.8, .serverThroughputOutlierLow: 2.5, .serverUnhealthy: 1.0, .largeCrossProviderThroughputVariance: 1.0,
        ...
        HypothesisModel(
            ...
            prior: HypothesisModel.defaultPrior,
            weights: [.burstTriggeredLoss: 0.3, .connectionDrops: 2.5, .pathChanged: 1.0, .lossBursty: 0.7, .noDropsObserved: -1.5],
            ruledOutBy: [], requiresAny: [], notApplicableWhen: [],
        ...
        HypothesisModel(
            ...
            prior: -2.5,
            weights: [.thermalStateChangedDuringLoad: 0.3, .allInterfacesDegraded: 2.5, .allServersAnomalous: 0.3, .vpnActive: 0.5,
